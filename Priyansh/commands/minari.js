...
const chatbot  =  new  Chatbot({name: "Minari", gender: "Najimi"});
 ...
 if(res === "My dear great botmaster, Robin.") {
    api.sendMessage(`I made by master Robin, also known as Robin`, event.threadID, event.messageID)
    return;
              }   
      if(res === "My birthplace is Robin laptop. What is your birthplace?") {
    ...
    return;
            ...
            if(res === "I was created by Robin.") {
    api.sendMessage(`I was created by Robin.`, event.threadID, event.messageID)
    return;
              }     
